    ...
    <table style="width: 100%;">
        ...
        if($gKeyIII > 0){
            ...
            foreach ($rPart AS &$rP){
                ...
                if($T_PartNumber == "1270-0023-0000|01"){
                    //echo $T_Assemblies;
                }
                ...
                //Busca alternativos
                $sAlt = "SELECT Mfgr_Name, Prim_Ven, Mfgr_Item_Nbr FROM PartData WHERE Item_Number = '$T_PartNumber' GROUP BY Mfgr_Name, Prim_Ven, Mfgr_Item_Nbr ORDER BY Prim_Ven ASC";
                ...
                //$OrdenArr = 1;
                //$Movements = "</tr>"
                $ArrayDatos[] = array($T_PartNumber, $T_Description, $TNote, $Movements, $TAlternative, $T_Mfgr, $T_MfgrPN, $T_OnHand, $T_OverIssue, $T_LeadTime, $D_w1, $D_w2, $D_w3, $D_w4, $D_w5, $D_w6, $D_w7, $D_w8, $D_w9, $D_w10, $D_w11, $D_w12, $OrdenArr, $ArrNConfirm, $ArrExpired, $T_QtyExpired, $ArrConfirm, $T_Assemblies, $qtyConf, $qtyDemand, $T_Engr);
                //$D_w1 = 0;
            ...
            foreach ($ArrayDatos AS &$AD){
                ...
                $A_MfgrY = "\"$A_Mfgr\"";
                $A_MfgrPNY = "\"$A_MfgrPN\"";
                array_push($ArrParts[$ArrV], 'Shortage w/conf PO', $A_PartNumber, $A_DescriptionY, $A_MfgrY, $A_MfgrPNY, $A_OnHand, $A_OverIssue, $A_LeadTime, $A_w1, $A_w2, $A_w3, $A_w4, $A_w5, $A_w6, $A_w7, $A_w8, $A_w9, $A_w10, $A_w11, $A_w12,$A_QtyConf,$A_Demand,$A_QExpired,$A_TAssy,$A_Engr);
...
<div style="width:100%;font-family: 'Roboto';font-size:1em;text-align: center;font-weight: 100;">
    ...
    case "vCustomer":
        ...
        $sPreload = "SELECT * FROM ConsultPP WHERE Customer = '$gCustomer' AND Assembly = '0' ORDER BY DTConsult DESC LIMIT 0, 1";
