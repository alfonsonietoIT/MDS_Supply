...
switch ($sII){
    case "LoadDemand":
        ...
        $vRedirect = "Dynamic.php?sI=$sI&sII=vClearTB&sIII=getDemand&sIV=Home&token=$gettoken&tokeni=$gettokeni&tokenii=$gettokenii&KeyI=$getKeyI&KeyII=$getKeyII&KeyIII=1";
        $vATime = 100;
    ...
    case "vClearTB":
        ...
        $LinkAction = "Dynamic.php?sI=$sI&sII=vClearTB&sIII=PostDemand&sIV=Home&token=$gettoken&tokeni=$gettokeni&tokenii=$gettokenii&KeyI=$getKeyI&KeyII=$getKeyII&KeyIII=$loadKey";
        //*print_r($ArrFriday);
...
<div style="width:100%;font-family: 'Roboto';font-size:1em;text-align: center;font-weight: 100;">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <th colspan="4" scope="col">
                ...
                switch ($gKeyIII){
                    case 1:
                        ?>
                <a class="linkr" href="Dynamic.php?sI=<?php echo $sI;?>&sII=vClearTB&sIII=getDemand&sIV=Home&token=<?php echo $gettoken;?>&tokeni=<?php echo $gettokeni;?>&tokenii=<?php echo $gettokenii;?>&KeyI=<?php echo $getKeyI;?>&KeyII=<?php echo $getKeyII;?>&KeyIII=2" target="_self">[+] Show All Assemblies</a>
                        <?php
                        break;
                    case 2:
                        ?>
                <a class="linkr" href="Dynamic.php?sI=<?php echo $sI;?>&sII=vClearTB&sIII=getDemand&sIV=Home&token=<?php echo $gettoken;?>&tokeni=<?php echo $gettokeni;?>&tokenii=<?php echo $gettokenii;?>&KeyI=<?php echo $getKeyI;?>&KeyII=<?php echo $getKeyII;?>&KeyIII=1" target="_self">[-] Hide Assemblies</a>
                        <?php
                        break;
                }
        ...
        if($gClassCode == "BWG1"){
            //Obtiene TOH
            $sTOH = "SELECT * FROM TempOH WHERE ClassCode = '$gClassCode'";
            $rTOH = $cnx->query($sTOH)->fetchAll();
            
            foreach ($rTOH AS &$TOH){
                $TOHPart = $TOH['Part'];
                $TOHQty = $TOH['Qty'];
                $ArrTOH[$TOHPart] = $TOHQty;
            }
        ...
        if($gKeyIII > 0){
            ...
            foreach ($rPart AS &$rP){
                ...
                */
                ...
                $T_w1 = $T_w2 = $T_w3 = $T_w4 = $T_w5 = $T_w6 = $T_w7 = $T_w8 = $T_w9 = $T_w10 = $T_w11 = $T_w12 = 0;
                
                if($gClassCode == "BWG1" && isset($ArrTOH[$T_PartNumber])){
                    $T_w1 = $ArrTOH[$T_PartNumber];
                }
                ...
                if($gClassCode == "BWG"){
                    ...
                    $sQtyConsignado = "SELECT SUM(Balance_Due) AS QtyBalance FROM PodData "
                            . "WHERE Part_Nbr = '$T_PartNumber' AND Purch_Order_Number LIKE '9C%'";
                    ...
                    $sQtyOH = "SELECT SUM(Qty_On_Hand) AS QtyOH FROM PartData "
                            . "WHERE Item_Number = '$T_PartNumber'";
                    //$nQtyConsignado = $cnx->query($sQtyConsignado)->numRows();
                    ...
                    $sQtyOHI = "SELECT SUM(On_Hand_Quantity_By_Loc) AS QtyINSP FROM PartData "
                            . "WHERE Item_Number = '$T_PartNumber' AND Location = 'INSP'";
                    //$nQtyConsignado = $cnx->query($sQtyConsignado)->numRows();
                ...
                foreach ($ArrFriday as &$ViernesOPO) {
                    ...
                    //Label y Ribon
                    if($T_Mfgr == "NAZDAR COMPANY" || $T_PartNumber == "18-001029-01|01" || $T_PartNumber == "27-010109-20|01" || $T_PartNumber == "DIG-001R|01" || empty($T_MfgrPN) || strpos(strtolower($T_Description), "label") !== false || strpos(strtolower($T_Description), "ribbon") !== false){
                            $$BWee = 1000;
                    } else {
                        if($Delta < 0){
                            $$BWee = -1;
                ...
                //$OrdenArr = 1;
                //$Movements = "</tr>"
                $ArrayDatos[] = array($T_PartNumber, $T_Description, $TNote, $Movements, $TAlternative, $T_Mfgr, $T_MfgrPN, $T_OnHand, $T_OverIssue, $T_LeadTime, $D_w1, $D_w2, $D_w3, $D_w4, $D_w5, $D_w6, $D_w7, $D_w8, $D_w9, $D_w10, $D_w11, $D_w12, $OrdenArr, $ArrNConfirm, $ArrExpired, $T_QtyExpired, $ArrConfirm, $T_Assemblies, $qtyConf, $qtyDemand);
            ...
            foreach ($ArrayDatos AS &$AD){
                ...
                $A_MfgrY = "\"$A_Mfgr\"";
                $A_MfgrPNY = "\"$A_MfgrPN\"";
                array_push($ArrParts[$ArrV], 'Shortage', $A_PartNumber, $A_DescriptionY, $A_MfgrY, $A_MfgrPNY, $A_OnHand, $A_OverIssue, $A_LeadTime, $A_w1, $A_w2, $A_w3, $A_w4, $A_w5, $A_w6, $A_w7, $A_w8, $A_w9, $A_w10, $A_w11, $A_w12,$A_QtyConf,$A_Demand,$A_QExpired);
    ...
    if(!empty($ArrSave)){
        $LinkDPP = "Include/reportCSV.php?report=CTB_ProductionPlan";
    ...
    if(!empty($ArrSave)){
        $LinkDPP = "Include/reportCSV.php?report=CTB_ImpactProductionPlan";
...
<div style="width:100%;font-family: 'Roboto';font-size:1em;text-align: center;font-weight: 100;">
    ...
    case "vClearTBAnt1":
        ...
        $LinkAction = "Dynamic.php?sI=$sI&sII=vClearTB&sIII=PostDemand&sIV=Home&token=$gettoken&tokeni=$gettokeni&tokenii=$gettokenii&KeyI=$getKeyI&KeyII=$getKeyII";
        //*print_r($ArrFriday);
        //*echo $gCustomer . "-" . $gClassCode;
        //Buscar Guardados
        $SSaved = "SELECT Name, DateSaved FROM DemandSaved WHERE ClassCode = '$gClassCode' GROUP BY Name, DateSaved ORDER BY Name ASC, DateSaved DESC LIMIT 0, 10";
...
<div style="width:100%;font-family: 'Roboto';font-size:1em;text-align: center;font-weight: 100;">
    ...
    case "vCustomer":
        ...
        $sPreload = "SELECT * FROM ConsultPP WHERE Customer = '$gCustomer' ORDER BY DTConsult DESC LIMIT 0, 1";
        ...
        if($nPreload == 1){
            ...
            $vATipo = "Verde";
            $vAMensaje = "Redirect Site...!";
            $vRedirect = "Dynamic.php?sI=$sI&sII=vClearTB&sIII=$sIII&sIV=Home&token=$gettoken&tokeni=$gettokeni&tokenii=$gettokenii&KeyI=$getKeyI&KeyII=$getKeyII&KeyIII=$gKeyIII";
            $vATime = 100;
            echo Alerta($vATipo, $vAMensaje, $vRedirect, $vATime);
        } else {
            ...
            $vRedirect = "Dynamic.php?sI=$sI&sII=vClearTB";
            $vATime = 100;
            echo Alerta($vATipo, $vAMensaje, $vRedirect, $vATime);
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td style="width:5%;">
                ...
                $sCust = "SELECT DISTINCT Customer FROM ConsultPP WHERE Customer != '' ORDER BY Customer ASC";
            ...
            <td style="width:50%;">
                ...
                $sCust = "SELECT * FROM ConsultPP WHERE Assembly = '0' ORDER BY DTConsult DESC LIMIT 0, 100";
                $lCust = $cnx->query($sCust)->fetchAll();
                ...
                //campos: action, label, id, class, tipo, name, value, checked, selected, focus  
                $aFields = array(
                    array("Dynamic.php?sI=$sI&sII=vClearTB&sIII=$sIII&sIV=$sIV&token=$gettoken&tokeni=$gettokeni&token=$gettokeni", "", "formx", "formx", "post", "addfile", "", "", "", ""),
