...
/***************************************************************************** Valida Customer ***********************/
$sCustomer = "SELECT Customer, Class_Code FROM PodData WHERE Class_Code = 'NUM' GROUP BY Customer, Class_Code ORDER BY Customer";
/*$sCustomer = "SELECT Customer, Class_Code FROM PodData WHERE Class_Code = 'ZWO' OR Class_Code = 'RAB' "
        . "OR Class_Code = 'BOS' OR Class_Code = 'PSX' OR Class_Code = 'CLI' OR Class_Code = 'KEN' "
        . "OR Class_Code = 'JAN' OR Class_Code = 'MEX' GROUP BY Customer, Class_Code ORDER BY Customer";*/
