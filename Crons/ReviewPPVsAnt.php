<?php
include '/home/softwaredevelop/public_html/masterwork/PHPClass/DB.php';
include '/home/softwaredevelop/public_html/masterwork/PHPFunctions/var.php';
include '/home/softwaredevelop/public_html/masterwork/PHPFunctions/Function_SMS.php';
...
//Agrega los PPV
$sPPV = "SELECT * FROM PodData WHERE Status = 'forPPV'";
...
foreach ($rPPV as &$rXPPV) {
    ...
    $g_Currency_List_Unit_Price = $rXPPV['Balance_Due'];
