    ...
    case "Home":
        switch ($sIV){
            case "Home":
                ...
                $aGList = array("Dashboard List", "50%", "", "", "0", "MPN, SUPPLIER, MANUFACTURER");
                ...
                if(isset($_GET['search'])){
                    ...
                    $LQry = "SELECT * FROM Dashboard ORDER BY idDashboard DESC";
                }
                
                
                
                $aColumns = array(
                    array("", "tr_class", "tit_col_center", "#", "tit_col_center", "+", "tit_col_center", "Dashboard")
                );
                $LRows = $cnx->query("$LQry")->fetchAll();
                foreach ($LRows as &$LRowsx) {
                    $count++;
                    ...
                    $get_id = $LRowsx['idDashboard'];
                    $get_keyI = $LRowsx['KeyI'];
                    $get_keyII = $LRowsx['KeyII'];
                    $get_keyIII = $LRowsx['KeyIII'];
                    $get_Dashboard = $LRowsx['Dashboard'];
                    $KI = base64_encode($get_keyI);
                    $KII = base64_encode($get_keyII);
                    $KIII = base64_encode($get_keyIII);
                    
                    $getLink = "Dashboard.php?KeyI=$KI&KeyII=$KII&KeyIII=$KIII";
                    ...
                    $goptions .= "<a href='$getLink' target='_blank' title='View $get_Dashboard'>"
                        . "<img src='Images/View.svg' title='View $get_Dashboard' width='16' border='0'></a>";
                    
                    
                    $aColumns[] = array("$bcolor", "", "col_center", "$count", "col_center", "$goptions", 
                        "col_center", "$get_Dashboard");
